...
if [ -d "/etc/squid3/" ]
then
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/squid1.txt -O /tmp/sqd1
	echo "acl url3 dstdomain -i $ipdovps" > /tmp/sqd2
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/squid2.txt -O /tmp/sqd3
	cat /tmp/sqd1 /tmp/sqd2 /tmp/sqd3 > /etc/squid3/squid.conf
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/payload.txt -O /etc/squid3/payload.txt
	echo " " >> /etc/squid3/payload.txt
	grep -v "^Port 443" /etc/ssh/sshd_config > /tmp/ssh && mv /tmp/ssh /etc/ssh/sshd_config
	echo "Port 443" >> /etc/ssh/sshd_config
	grep -v "^PasswordAuthentication yes" /etc/ssh/sshd_config > /tmp/passlogin && mv /tmp/passlogin /etc/ssh/sshd_config
	echo "PasswordAuthentication yes" >> /etc/ssh/sshd_config
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/addhost.sh -O /bin/addhost
	chmod +x /bin/addhost
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/alterarsenha.sh -O /bin/alterarsenha
	chmod +x /bin/alterarsenha
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/criarusuario2.sh -O /bin/criarusuario
	chmod +x /bin/criarusuario
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/delhost.sh -O /bin/delhost
	chmod +x /bin/delhost
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/expcleaner2.sh -O /bin/expcleaner
	chmod +x /bin/expcleaner
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/mudardata.sh -O /bin/mudardata
	chmod +x /bin/mudardata
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/remover.sh -O /bin/remover
	chmod +x /bin/remover
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/sshlimiter2.sh -O /bin/sshlimiter
	chmod +x /bin/sshlimiter
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/alterarlimite.sh -O /bin/alterarlimite
	chmod +x /bin/alterarlimite
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/ajuda.sh -O /bin/ajuda
	chmod +x /bin/ajuda
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/sshmonitor2.sh -O /bin/sshmonitor
...
if [ -d "/etc/squid/" ]
then
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/squid.txt -O /tmp/sqd1
	echo "acl url3 dstdomain -i $ipdovps" > /tmp/sqd2
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/squid.txt -O /tmp/sqd3
	cat /tmp/sqd1 /tmp/sqd2 /tmp/sqd3 > /etc/squid/squid.conf
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/payload.txt  -O /etc/squid/payload.txt
	...
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/addhost.sh  -O /bin/addhost
	chmod +x /bin/addhost
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/addhost.sh -O /bin/alterarsenha
	chmod +x /bin/alterarsenha
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/criarusuario2.sh -O /bin/criarusuario
	chmod +x /bin/criarusuario
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/delhost.sh -O /bin/delhost
	...
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/remover.sh -O /bin/remover
	chmod +x /bin/remover
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/sshlimiter2.sh -O /bin/sshlimiter
	chmod +x /bin/sshlimiter
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/alterarlimite.sh -O /bin/alterarlimite
	chmod +x /bin/alterarlimite
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/sshlimiter2.sh -O /bin/ajuda
	chmod +x /bin/ajuda
	wget https://raw.githubusercontent.com/adailtonsuporte/vpsmanager2/master/sshmonitor2.sh -O /bin/sshmonitor
	chmod +x /bin/sshmonitor
...
echo ""
tput setaf 7 ; tput setab 4 ; tput bold ; echo "Proxy Squid Instalado e rodando nas portas: 80, 3128, 8080" ; tput sgr0
